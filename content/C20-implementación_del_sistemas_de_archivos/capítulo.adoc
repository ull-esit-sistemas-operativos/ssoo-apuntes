...
Por ejemplo, la FAT de MS-DOS 3.0 y posteriores usaba 16bits para numerar los clústeres —por eso se llamaba FAT16—.
...
Por eso —entre otras cosas— Microsoft introdujo {fat32}, que utiliza 32bits para numerar los clústeres.
