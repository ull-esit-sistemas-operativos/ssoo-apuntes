...
En {anom_shared_memory_cpp} se puede ver un ejemplo muy simple, similar a {forkpipe_c} pero utilizando memoria compartida para comunicar ambos procesos.
...
En {shared_memory_server_cpp} y {shared_memory_client_cpp} se puede ver el ejemplo de un programa que muestra periódicamente la hora del sistema.
