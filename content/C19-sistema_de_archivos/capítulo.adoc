...
Como el cliente lee el archivo con una única operación {linux_read} y el servidor lo escribe con una única operación {linux_write}, no hacen falta el uso de bloqueo de archivos para sincronizarlos.
