...
de forma que siempre haya suficientes porciones stem:[M] para que cada proceso pueda tener al menos una, limitando por debajo el número de porciones a repartir a stem:[\text{floor}(L / M)].
...
Si hay pocos procesos, stem:[g = \text{floor}(L / M)], por lo que a cada proceso se le asignan varias porciones stem:[M] de tiempo de CPU del periodo stem:[L].
