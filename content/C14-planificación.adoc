...
Linux, desde la versión 2.6.23, utiliza un tipo de *planificador equitativo ponderado* denominado *((CFS))* (_Completely Fair Scheduler_) o *planificador completamente equitativo*(((planificador, completamente equitativo))) (véase https://developer.ibm.com/tutorials/l-completely-fair-scheduler/[«Inside the Linux 2.6 Completely Fair Schedule -- IBM Developer»]).
Otro ejemplo es {zircon} —el _microkernel_ de {google_fuchsia}— que está inmerso en cambiar su actual planificador basado en colas multinivel con prioridades a una implementación del *planificador equitativo ponderado* (véase https://fuchsia.dev/fuchsia-src/concepts/kernel/fair_scheduler[«Zircon Fair Scheduler -- Fuchsia Project»]).
...
Desde el punto de vista de Windows API, todo proceso pertenece a alguna de las 6 clases de prioridad de la <<tabla-win32-clases-prioridad>>.
