...
// TODO: (A) Diagrama de Gantt de FCFS
...
// TODO: (A) hacer también versión cooperativa
...
Si durante un periodo de tiempo _T_, un proceso _P~i~_ tiene peso _w~i~_, a ese proceso le corresponde un tiempo de CPU _t~i~_:
...
donde _W_ es la suma de los pesos de todos los procesos en la *cola de preparados* durante _T_. 

// TODO: (A) El problema es que los procesos entran y salen de la cola de preparados, por lo que este cálculo es dinámico.
// Hacer un problema como los que hemos visto en otros planificadores
