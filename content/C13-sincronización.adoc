...
En {pthreads_sync_cpp} se puede estudiar el código completo de un ejemplo similar a {pthreads_cpp}, donde se calculaba el factorial de un número, repartiendo la tarea entre dos hilos, usando la API de {pthreads}.
