...
[[estructura_sistema_de_archivos]]
.Estructura de un sistema de archivos.
...
En la <<estructura_sistema_de_archivos>> se muestra un ejemplo típico de la estructura de un sistema de archivos diseñado en niveles.
