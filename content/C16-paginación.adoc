...
image::{chapdir}/dirección_virtual_paginación.svg[]
...
image::{chapdir}/bit_de_válido_en_la_tabla_de_páginas.svg[]
...
image::{chapdir}/paginación_jerárquica.svg[]
...
image::{chapdir}/dirección_virtual_paginación_jerárquica.svg[]
...
image::{chapdir}/dirección_virtual_vax.svg[]
