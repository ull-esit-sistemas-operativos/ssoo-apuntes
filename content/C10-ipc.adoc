...
** Con *capacidad limitada*(((capacidad, limitada))) la cola tiene una capacidad máxima de _N_ mensaje, por lo que si la cola se llena el proceso transmisor se bloquea a la espera de que haya espacio en la cola.
