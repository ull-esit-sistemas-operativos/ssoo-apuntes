...
Qué es un sistema operativo, cuáles son sus responsabilidades, en el contexto de un sistema informático, y cómo cumple con ellas, son algunas de las cuestiones que responderemos en este capítulo.
