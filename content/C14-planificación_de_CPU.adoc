...
:chapdir: C14-planificación_de_CPU
...
Si desarrollamos la formula sustituyendo los valores, veremos que _t~n~_ se pondera con _{alpha}_, _t_~_n_-1~ con (1 - _{alpha}_)_{alpha}_, _t_~_n_-2~ con(1 - _{alpha}_)^2^_{alpha}_, y así sucesivamente:
