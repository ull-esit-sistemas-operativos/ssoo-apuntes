...
* Algunos análisis estadísticos realizados con el *primer ajuste* revelan que incluso con algunas optimizaciones, con stem:[N] bloques asignados se pierden stem:[0,5N] por *fragmentación externa* —es decir, un tercio de toda la memoria no es utilizable—.
