...
* *Interfaz gráfica de usuario*(((interfaz, gráfica de usuario))) o *(GUI)* (_Graphical User Interface_) que permite a los usuarios utilizar un sistema de ventanas y menús controlable mediante el ratón.
