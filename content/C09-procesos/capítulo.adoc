...
Como ya hemos comentado con anterioridad, un *proceso* es un programa en ejecución (véase el <<componente_gestión_de_procesos>> para una definición más completa).
...
[NOTE]
====
Como vimos en el <<componente_gestión_de_procesos>> varios procesos pueden estar asociados al mismo programa pero no por eso dejan de ser distintos procesos.
