...
. El sistema operativo cargaba varios trabajos en memoria del conjunto de trabajos en la cola en el disco magnético (véase la <<fig-sistemas-multiprogramados>>).
