...
Todos comparten los mismos recursos, pueden acceder a los mismos dispositivos (véase la <<smp>>) y cada uno ejecuta una copia del núcleo del sistema operativo.
