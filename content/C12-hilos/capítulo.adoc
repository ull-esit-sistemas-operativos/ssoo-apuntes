...
El código fuente completo de este ejemplo está disponible en {pthreads_cpp} y, además, permite indicar el número que queramos para calcularle el factorial.
