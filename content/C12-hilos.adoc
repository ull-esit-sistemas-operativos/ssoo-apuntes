...
<4> Cada objeto {cpp_thread} tiene un identificador que sirve para identificar el hilo.
Este identificado no tiene que tener ninguna relación con los identificadores o manejadores utilizados por el sistema operativo para identificar los hilos.
