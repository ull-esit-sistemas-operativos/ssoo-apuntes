...
Al utilizar un hilo para manejar las señales, tenemos a nuestra disposición cualquier función *segura en hilos* y sabemos cómo proteger las variables y estructuras de datos compartidas mediante el uso de mecanismos de *sincromización* (véase el <<_sincronización>>).
