...
En el <<ejemplo_pthread>> se puede ver cómo se usa {pthread_create} en sistemas POSIX que implementan {pthreads} para crear varios hilos y esperar a que terminen con {pthread_join}.
[[ejemplo_pthread]]
