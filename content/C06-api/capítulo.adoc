...
Sin embargo, debemos valorar que así perdemos portabilidad, ya que ahora nuestro programa ya no podrá usarse allí donde haya un compilador o intérprete de nuestro lenguajes, sino solo en sistemas operativos con una *librería del sistema* compatible.
****
