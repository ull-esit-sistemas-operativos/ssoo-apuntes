...
La solución al retraso originado por el acceso a la tabla de páginas, cuando ésta está en la memoria, pasa por que el sistema disponga de un pequeño caché de traducciones en hardware llamado *((TLB))* (_Translation Look-aside Buffer_).
