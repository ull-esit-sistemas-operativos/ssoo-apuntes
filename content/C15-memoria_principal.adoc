...
Finalmente, debemos confundir la *librería de tiempo de ejecución* con la *librería estándar*.
En lenguajes como C o {cpp} se distingue claramente entre el lenguaje y la librería estándar que suele acompañarlos.
