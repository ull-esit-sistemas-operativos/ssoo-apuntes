...
* El segundo número es incrementado cuando se añade alguna nueva características o se modifica alguna ya existente, pero el cambio no debe romper los programas hechos para la versión anterior.
