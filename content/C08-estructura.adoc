...
image::{sectiondir}/estructura_msdos.svg[]
...
image::{sectiondir}/estructura_unix.svg[]
...
image::{sectiondir}/estructura_os2.svg[]
...
image::{sectiondir}/estructura_minix3.svg[]
...
image::{sectiondir}/estructura_linux.svg[]
