...
* Las *tuberías anónimas*(((tubería, anónima))) sólo existen en el espacio de direcciones del proceso que las crea, de tal forma que debe heredarse de padres a hijos para que otros procesos puedan tener acceso.
