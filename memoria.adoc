...
Compartir páginas no sólo permite ahorrar memoria pues en _los sistemas operativos modernos la memoria compartida (véase el apartado <<_memoria_compartida>>) se implementa mediante páginas compartidas_.
...
Como ya comentamos al estudiar el método básico de paginación (véase el apartado <<_paginación>>), una decisión de diseño importante es escoger el tamaño adecuado para las páginas:
