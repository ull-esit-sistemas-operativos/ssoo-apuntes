...
:imagesdir: {imagesdir}/introducción

=== ¿Qué es un sistema operativo?

En general no existe una definición universal de lo qué es un *((sistema operativo))*, aunque si muchas propuestas por parte diferentes autores:
